...
| certora `health_factor_bounds.spec` | Health factor bounds & monotonicity | HF-001 � HF-007 (Issue #687) |
| certora `interest_accrual.spec` | Interest accrual invariants | IA-001 � IA-008 (Issue #687) |
